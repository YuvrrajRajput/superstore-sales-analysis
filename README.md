...
Open SuperstoreData.xlsx in Microsoft Excel (2019 or later recommended for XLOOKUP support)
Open Financial_Performance_Dashboard.pdf to view the Power BI report export
To interact with the live Power BI file, import the dataset into Power BI Desktop and rebuild using the DAX measures documented above
